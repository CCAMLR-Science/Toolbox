...
include_graphics("./Codes/Biological_Parameters/age-at-maturity.png")
```
...
```{r fig.align="center",out.width="75%",echo=F}
include_graphics("./Codes/Biological_Parameters/vbgf-1.png")
```
...
```{r fig.align="center",out.width="75%",echo=F}
include_graphics("./Codes/Biological_Parameters/vbgf-2.png")
```
...
```{r fig.align="center",out.width="75%",echo=F}
include_graphics("./Codes/Biological_Parameters/length-weight.png")
```
