...
```{r fig.align="center",out.width="100%",message=F,dpi=300,echo=F,fig.cap="Figure 1. Map of Subarea 48.6 and its Research Blocks ([Source](https://github.com/ccamlr/CCAMLRGIS/blob/master/Basemaps/Basemaps.md#basemaps))."}
